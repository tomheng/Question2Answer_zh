...
*/
	...
	return array(
		...
		'permit_create_eds_mods' => '创建编辑和moderators:',
		'permit_create_experts' => '创建专家:',
		'permit_delete_users' => '删除用户:',
		'permit_editors' => '编辑、Moderators、管理员',
		'permit_experts' => '专家、编辑、Moderators、管理员',
		'permit_moderators' => 'Moderators和管理员',
